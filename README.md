...
* boolean: valor lógico (verdade/falso) 
...
Percebaa que no momento de inserção dos dados na tabela utilizamos a função específica _lo_import()_, que é utilizada para carregar imagens para a tabela de sistema pg_largeobjects.
...
# Stored Procedure/Functions/Procedures
...
<!-- 
![](https://github.com/IgorAvilaPereira/pbd2024_1sem/raw/main/tabela_privilegio.png)
...
* [Video Encontro - 23/09](https://www.youtube.com/watch?v=aidpYrgnjak)
...
<!--* [Resolução - Lista 10 SQL](https://youtu.be/AlL9DcKTOrY)-->
